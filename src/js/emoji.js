...
// Возможности современного Unicode Emoji (http://unicode.org/reports/tr51/) все еще не позволяют
// правильно определять все возможные эмодзи, поэтому здесь используется такая гигантская регулярка.
...
export default function(text = '') {
  return text.replace(emojiRegex, generateEmojiImage);
}
