...
export const ConvoListItem = defineComponent<Props>((props) => {
  ...
  return () => {
    ...
    const typingUsers = props.convo.id === 88262293
      ? [{ type: 'text' as const, peerId: props.convo.id, cancelTypingTimeoutId: 0 }]
      : typings.get(props.convo.id)
    ...
    return (
      ...
      >
        ...
        <div class="ConvoListItem__message">
          {typingUsers?.length ? (
            <ConvoTyping typingUsers={typingUsers} />
          ) : (
            <>
