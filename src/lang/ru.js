export default {
  ...
  im_messages_view: ['Просмотр сообщения', 'Просмотр сообщений'],
  ...
  im_chat_title_update: [
    '{0} изменили название беседы: «{1}» → «{2}»',
    '{0} изменил название беседы: «{1}» → «{2}»',
    '{0} изменила название беседы: «{1}» → «{2}»'
  ],
  im_chat_pin_message: [
  ...
  // Возможен вариант только "Вы ..."
  im_chat_kick_don: '{0} исключены из беседы, так как у вас закончилась платная подписка на сообщество',
  im_chat_screenshot: [
  ...
  im_conversation_style_update: [
    '{0} изменили оформление чата на «{1}»',
    '{0} изменил оформление чата на «{1}»',
    '{0} изменила оформление чата на «{1}»'
  ],
  im_conversation_style_reset: [
    '{0} сбросили оформление чата',
    '{0} сбросил оформление чата',
    '{0} сбросила оформление чата'
  ],
  ...
  ml_blocked_account_content: [
    `Возможно, вы завершили сеанс в настройках или сменили пароль.<br><br>
    Для продолжения работы авторизуйтесь в приложении еще раз.`,
